...
// Disable dynamic images and fall back to regular Timber resize filter
...
// Set upload directory relative to web root. If there are issues with image generation, this filter most likes needs to be used. Can be related to having a custom WordPress folder structure or plugins that manipulate home_url.
